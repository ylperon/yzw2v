...
void yzw2v::num::Prefetch(const float* v) noexcept {
    ...
    _mm_prefetch(v, _MM_HINT_T2);
    _mm_prefetch(v + 4, _MM_HINT_T2);
    _mm_prefetch(v + 8, _MM_HINT_T2);
    _mm_prefetch(v + 12, _MM_HINT_T2);
    _mm_prefetch(v + 16, _MM_HINT_T2);
    _mm_prefetch(v + 20, _MM_HINT_T2);
    _mm_prefetch(v + 24, _MM_HINT_T2);
    _mm_prefetch(v + 28, _MM_HINT_T2);
}
